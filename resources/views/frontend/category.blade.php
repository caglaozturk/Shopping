                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="{{ route('product',$product->slug) }}">
                                                    <img src="{{ $image_url.$counter }}.jpg" alt="Li's Product Image">
                                                </a>
                                                ...
                                                <div class="product_desc_info">
                                                    <div class="product-review">
                                                        <h5 class="manufacturer">
                                                            <a href="{{ route('product',$product->slug) }}">{{ substr($product->description,0,20).'.' }}</a>
                                                        </h5>
                                                    ...
                                                    <h4><a class="product_name" href="{{ route('product',$product->slug) }}">{{ $product->product_name }}</a></h4>
                                                    <div class="price-box">
